...
# where is the file
folder = '/home/php/Desktop/AFM-master/Maps/map-data-2023.09.08-15.28.26.373_processed-2023.09.11-11.38.09/processed_curves-2023.09.11-11.38.09/20230911-115257-mechanics-results/'
nom='20230911-115257-data.txt'
experiment='mechanics' # adhesion, mechanics
condition="5kPa, FN, gel1" # F127 vs. F127, 500Pa
...
plt.ylim(0,histmaxprob)
plt.ylabel('Prob. density')
plt.title(titre)
texte="median="+str(np.round(cartedata['E'].median(), 1))+"Pa"
plt.text(25,histmaxprob/2., texte, fontsize=12, color='red') 
