...
methodpath = '/home/php/Bureau/PHP-DEV/Relaxation/fits/test-N/'
methofilename = 'method.txt'
methodloc= methodpath+methofilename
# data for processing
inputpath = '/home/php/Bureau/PHP-DEV/Relaxation/fits/test-N/fc/'
...
file.write("# Filename | Prefactor | alpha | t0 (sec) | R^2\n")
file.write("#---------------------------------------------------\n")
...
for fichier in files:
    ...
    # calculate the R2
    R2 = r2_score(piconewtons, fitted)
    ...
    if model == "power":
        ...
        alpha=fitParams[1]
    # output to file
    file.write(fichier+" "+str(prefac)+" "+str(alpha)+" "+str(t0)+" "+str(R2)+"\n")
