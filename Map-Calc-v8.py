...
methodpath = '/home/php/Desktop/AFM-master/Maps/'
methofilename = 'method-ma.txt'
methodloc= methodpath+methofilename
# data for processing.
# Be sure that the date is on the 'extend' segment.
inputpath ='/home/php/Desktop/AFM-master/Maps/map-data-2023.09.08-15.28.26.373_processed-2023.09.11-11.38.09/processed_curves-2023.09.11-11.38.09/'
...
for fichier in files:
    ...
    df1 = pd.read_csv(localfichier, delimiter=r"\s+",   comment='#', names=['h', 'f','h2', 'h3', 'h4','h5', 'h6', 't', 't2'], skiprows=80)
